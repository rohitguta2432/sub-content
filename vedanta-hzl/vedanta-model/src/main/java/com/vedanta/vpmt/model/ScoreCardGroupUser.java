 ...
 */
@Entity
@Table(name = "scorecard_group_users")
...
@AllArgsConstructor
@Builder
public class ScoreCardGroupUser implements Serializable {
	...
	@NotNull
	@Column(name = "template_id", columnDefinition = "bigint(20) default 0")
	...
	@NotNull
	@Column(name = "group_id", columnDefinition = "bigint(20) default 0")
	...
	@Column(name = "status", columnDefinition = "int(1) DEFAULT 2")
	private int status;
